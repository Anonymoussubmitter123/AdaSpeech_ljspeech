...
def main(args, configs):
    ...
    vocoder = get_vocoder(args.vocoder_config, args.vocoder_checkpoint)  # 训练时输入的args
...
if __name__ == "__main__":
    ...
    parser.add_argument("--restore_step", type=int, default=0)  # 模型从哪一步开始训练
    parser.add_argument(
        "-p",
        "--preprocess_config",
        type=str,
